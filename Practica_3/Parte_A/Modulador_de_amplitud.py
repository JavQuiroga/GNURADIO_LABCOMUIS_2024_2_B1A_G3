...
# Author: Javier Quiroga - Paula Rodriguez
# Copyright: uis
...
class Modulador_de_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fc_range = qtgui.Range(50e6, 2.2e9, 1e6, 200e6, 200)
        self._fc_win = qtgui.RangeWidget(self._fc_range, self.set_fc, "frecuencia_portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._GTX_range = qtgui.Range(0, 30, 1, 20, 200)
        ...
        self._Ac_win = qtgui.RangeWidget(self._Ac_range, self.set_Ac, "Amplitud_portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._fm_win = qtgui.RangeWidget(self._fm_range, self.set_fm, "frecuencia_mensaje", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fm_win)
        self.blocks_uchar_to_float_0 = blocks.uchar_to_float()
        self.blocks_uchar_to_float_0.set_block_alias("blocks_uchar_to_float_0")
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_char*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_float*1, B)
        self.blocks_repeat_0.set_block_alias("blocks_repeat_0")
        ...
        self.blocks_multiply_const_vxx_0_0.set_block_alias("blocks_mu")
        ...
        self.blocks_add_const_vxx_0_0.set_block_alias("blocks_add_const_vxx_0")
        ...
        self.analog_random_source_x_0.set_block_alias("analog_random_source_x_0")
        self._Am_range = qtgui.Range(0, 4, 100e-3, 1, 200)
        self._Am_win = qtgui.RangeWidget(self._Am_range, self.set_Am, "Amplitud_mensaje", "counter_slider", float, QtCore.Qt.Horizontal)
