...
class ModulacionFMRX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fc_win = qtgui.RangeWidget(self._fc_range, self.set_fc, "Frecuecia de portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._GRX_range = qtgui.Range(0, 30, 1, 0, 200)
        self._GRX_win = qtgui.RangeWidget(self._GRX_range, self.set_GRX, "Ganancia del transmisor", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.connect((self.rational_resampler_xxx_0, 0), (self.audio_sink_1, 0))
