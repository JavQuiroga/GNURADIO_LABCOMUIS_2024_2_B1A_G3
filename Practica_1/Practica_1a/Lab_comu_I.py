...
# Title: Teorema_Nyquist
# Author: Javier_Quiroga_Paula_Rodriguez_B1A_G3
...
class Lab_comu_I(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Teorema_Nyquist", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Teorema_Nyquist")
