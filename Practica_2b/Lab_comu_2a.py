...
# Title: generador
# Author: Paula Rodriguez, Javier Quiroga
...
class Lab_comu_2a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Lab_comu_2a")
        ...
        self._fm_range = qtgui.Range(1e3, 1e6, 1e3, 10e3, 200)
        self._fm_win = qtgui.RangeWidget(self._fm_range, self.set_fm, "Frequencia Señal", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fm_win)
        self._fcut_range = qtgui.Range(0, samp_rate/2, 100, samp_rate/2, 200)
        self._fcut_win = qtgui.RangeWidget(self._fcut_range, self.set_fcut, "Frecuencia corte", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fcut_win)
        self._fc_range = qtgui.Range(50e6, 1e9, 1e5, 200e6, 200)
        ...
        self._GTX_win = qtgui.RangeWidget(self._GTX_range, self.set_GTX, "Gain Transmission", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.qtgui_time_sink_x_0.set_block_alias("qtgui_time_sink_x_0")
        ...
        self.qtgui_freq_sink_x_0.set_block_alias("qtgui_freq_sink_x_0")
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.low_pass_filter_0.set_block_alias("low_pass_filter_0")
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_throttle2_0.set_block_alias("blocks_thtottle2_0")
...
def main(top_block_cls=Lab_comu_2a, options=None):
